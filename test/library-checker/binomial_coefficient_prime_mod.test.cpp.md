...
data:
  ...
  bundledCode: "#line 1 \"test/library-checker/binomial_coefficient_prime_mod.test.cpp\"\
    ...
    \  if (sz > n) return;\n        if (n < sz << 1) n = std::min(mint::mod() - 1,\
    \ sz << 1);\n        facts.resize(n + 1);\n        ifacts.resize(n + 1);\n   \
    ...
    \ 6 \"test/library-checker/binomial_coefficient_prime_mod.test.cpp\"\nusing mint\
